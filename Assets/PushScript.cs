...
{
	const string api_key = "43eec6b7f0e821f7fc622589461deaffd65bd20d68462953d74a7b013a26bbfd";
	const string secret_key = "88fa44334532667534310afbf8cf0972040b39860fa48814641aa6ba78f44d82";
	...
	void onDidRegisterForRemoteNotificationsWithDeviceToken(string deviceToken)
	{
		...
		{
			registerDeviceTokenToApp42PushNotificationService(deviceToken,"rthirucs");
		}
//		SendPushToUser("rthirucs","Hello, Unity!!");
	}
